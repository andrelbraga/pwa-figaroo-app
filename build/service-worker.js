...
clientsClaim();
skipWaiting();
precacheAndRoute([{'revision':'fa88198cf49041f49b936d2aa23722ca','url':'/assets/manifest-icon-192.png'},{'revision':'932c7e1432923ccf4d713431c07692c0','url':'/assets/manifest-icon-512.png'},{'revision':'dcd682f8a3d0536d9d667d3265a8092d','url':'/favicon.ico'},{'revision':'cd492015c5e487adfb40beb02a8605f7','url':'/index.html'},{'revision':'e9f1cc9200ffc0b711def7328243f0c0','url':'/manifest.json'},{'revision':null,'url':'/static/css/main.ab95af2a.css'},{'revision':null,'url':'/static/js/main.4f39af7a.js'},{'revision':'fa88198cf49041f49b936d2aa23722ca','url':'/static/media/manifest-icon-192.de87e86f.png'},{'revision':'932c7e1432923ccf4d713431c07692c0','url':'/static/media/manifest-icon-512.74141d57.png'}]);
console.log(self);
...
registerRoute((req) => req.url.origin === self.location.origin && req.url.pathname.endsWith('.js'), new StaleWhileRevalidate({
    cacheName: 'js',
}));
registerRoute((req) => req.url.origin === self.location.origin && req.url.pathname.endsWith('.png') && req.url.pathname.endsWith('.jpg'), new StaleWhileRevalidate({
    cacheName: 'images',
    plugins: [
